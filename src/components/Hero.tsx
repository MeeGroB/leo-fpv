  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl mx-auto">
          ...
          <p className="text-2xl md:text-3xl bg-linear-to-r from-emerald-400 to-blue-500 bg-clip-text text-transparent font-light">Perspectivas de Alto Vuelo</p>

          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">Especialista en videografía aérea profesional con drones FPV. Capturamos movimientos dinámicos, perspectivas imposibles y contenido cinematográfico que destaca.</p>
